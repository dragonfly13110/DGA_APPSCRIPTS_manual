...
export const Introduction = () => (
  <div>
    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-8 rounded-2xl shadow-lg mb-10 text-center">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-2 tracking-tight">
        สถานการณ์เพาะปลูกข้าว จังหวัดฉะเชิงเทรา ฤดูนาปี 2568/69
      </h1>
      <div className="flex justify-center gap-4 mt-4 text-blue-100 font-medium">
        <span className="bg-white/20 px-4 py-1 rounded-full backdrop-blur-sm border border-white/30">
          📅 ช่วงเวลา: 1 พ.ย. 68 - 30 ต.ค. 69
        </span>
      </div>
    </div>

    <div className="bg-white border-l-4 border-amber-500 p-6 rounded-r-xl shadow-sm mb-10">
      <h3 className="text-lg font-bold text-slate-800 mb-2 flex items-center gap-2">
        <span className="text-amber-500"><Icons.Book /></span> วัตถุประสงค์ของเว็บไซต์นี้
      </h3>
      <p className="text-slate-600 leading-relaxed mb-4">
        เว็บไซต์นี้จัดทำขึ้นเพื่อเป็น <strong>"คู่มือต้นแบบ (Blueprint)"</strong> สำหรับหน่วยงานหรือนักพัฒนา ที่ต้องการนำระบบนี้ไปประยุกต์ใช้ต่อ
        ท่านสามารถนำ Source Code ไปปรับเปลี่ยนเป็น <strong>พืชชนิดอื่นๆ</strong> (เช่น มันสำปะหลัง, อ้อย, ทุเรียน) หรือนำไปใช้ใน <strong>พื้นที่จังหวัดอื่นๆ</strong> ได้ทันที
